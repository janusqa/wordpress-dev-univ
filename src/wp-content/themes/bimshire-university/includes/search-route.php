...
add_action('rest_api_init', 'university_register_search_routes');

function university_register_search_routes()
{
...
function university_search_results($data)
{
    ...
    $main_query = new WP_Query(array(
        ...
        's' => sanitize_text_field($data['term']), // This param enables searching by the value. extract value of key "term" from querystring
    ));
