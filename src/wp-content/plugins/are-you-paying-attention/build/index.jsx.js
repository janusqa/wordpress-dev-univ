...
(() => {
  let locked = false;
  wp.data.subscribe(() => {
    const shouldLock = wp.data.select("core/block-editor").getBlocks().some(block => block.name === 'janusplugin/are-you-paying-attention' && block.attributes.answer === undefined);
...
const EditComponent = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, "Answers:"), attributes.answers.map((answer, idx) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Flex, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.FlexBlock, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    value: answer,
    onChange: newValue => {
    ...
    icon: attributes.answer === idx ? "star-filled" : "star-empty"
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.FlexItem, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    variant: "link",
    className: "attention-delete",
    onClick: () => {
      setAttributes({
        answers: attributes.answers.filter((_, fidx) => fidx !== idx)
      });
      if (idx === attributes.answer) setAttributes({
        answer: undefined
      });
    }
